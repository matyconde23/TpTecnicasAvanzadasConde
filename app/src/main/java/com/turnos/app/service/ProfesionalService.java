...
public List<ProfesionalDisponibilidad> generarDisponibilidadPorDefecto() {
    ...
    // Usar DayOfWeek en lugar de String para los días de la semana
    final DayOfWeek[] diasSemana = {DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, DayOfWeek.THURSDAY, DayOfWeek.FRIDAY};
